  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleGuardar} className="bg-white p-6 rounded shadow space-y-6" ref={refFactura}>
        ...
        <button type="button" onClick={addLinea} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
          + Añadir línea
        </button>
        ...
        {customFields && <div className="border p-4 text-sm">[Inputs personalizados aquí]</div>}
        {mensajeFinal && (
          <textarea
            value={textoFinal}
      ...
      <div className="mt-4 flex gap-3">
        <button onClick={handleGuardar} className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Guardar Factura</button>
        <button onClick={exportPDF}    className="px-6 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700">Exportar PDF</button>
        {showQR && <button onClick={()=>setQrOpen(true)} className="px-6 py-2 bg-gray-600 text-white rounded hover:bg-gray-700">Ver QR</button>}
      </div>
